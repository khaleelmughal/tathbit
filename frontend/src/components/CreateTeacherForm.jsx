...
export default function CreateTeacherForm({ onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.name.trim() || !formData.email.trim() || !formData.password.trim() || !formData.className.trim()) {
    ...
    try {
      ...
      setSuccess(true);
      setFormData({ name: "", email: "", password: "", className: "", gradeId: "g5" });
    ...
    <Card>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Input
          ...
          placeholder="e.g., Grade 5A, Year 5 Red"
          disabled={loading}
        />
