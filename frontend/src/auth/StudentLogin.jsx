...
import { studentLogin, setToken } from "../lib/api";
...
export default function StudentLogin({ onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await studentLogin(username.trim(), pin.trim());
      ...
      <Card style={{ width: "100%", maxWidth: "400px" }}>
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          <div style={{
            ...
            <User size={32} style={{ color: T.green }} />
          </div>
          <h1 style={{
            fontSize: "32px",
        ...
        <div style={{
          ...
          <p style={{ color: T.faint, fontSize: "14px", margin: 0 }}>
            Staff member? <a href="/admin" style={{ color: T.green, textDecoration: "none" }}>Login here</a>
          </p>
        </div>
      </Card>
